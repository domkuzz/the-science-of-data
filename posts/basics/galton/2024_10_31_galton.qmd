...
<div style="text-align: left; margin-top: 15px;">
  ...
  <p style="margin-top: 15px;"><em>Figure 1: Sir Francis Galton (1822–1911) [@wiki:galton]</em></p>
</div>
...
and widely promoted regression towards the mean. The Galton Board, also known as Quincunx or Bean Machine, 
...
We observe that the probabilities are not the same for each bin. In fact, it is much more 
likely that the ball lands in the middle bins than in the outer bins. 
...
<div style="text-align: center;">
  <img src="images/pascal_triangle.png" alt="Pascal's Triangle" style="width:850px;">
